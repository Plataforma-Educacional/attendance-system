  ...
  return (
    <>
      <section className="flex h-full flex-col">
        ...
        <div className="border-x-2 border-[#5766da7e]">
          <button className="rounded-tr-2xl rounded-tl-lg bg-[#5766DA] px-4 py-2 text-white">
            Responder
          </button>
          <button className="rounded-tr-2xl rounded-tl-lg bg-[#313978] px-4 py-2 text-white">
            Mensagem Privada
          </button>
          <div className="flex h-[91px] items-center bg-[#5766DA]">
